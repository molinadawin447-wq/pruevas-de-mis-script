...
local function getClosestTarget()
    ...
    local closest,minDist=nil,math.huge    for _,plr in ipairs(Players:GetPlayers()) do
...
;(function()
    ...
    TL.Text="BRAxIL HUB V2"; TL.TextColor3=C.purple; TL.TextSize=17; TL.Font=Enum.Font.GothamBlack
    ...
    MiniBtn.Text="BRAxIL HUB V2"; MiniBtn.TextColor3=C.purple; MiniBtn.Font=Enum.Font.GothamBlack; MiniBtn.TextSize=11
...
;(function()
    ...
    for i,name in ipairs(Categories) do
        ...
        btn.BackgroundTransparency=0.3; btn.Text=name; btn.TextColor3=C.purple
        ...
        btn.MouseButton1Click:Connect(function()
            ...
            for n,b in pairs(CategoryRefs.btnsSide) do
                local ac=(n==name); b.TextColor3=C.purple; b.BackgroundTransparency=ac and 0.2 or 0.3
        ...
        btn.MouseEnter:Connect(function() if CategoryRefs.active~=name then btn.TextColor3=C.purple; btn.BackgroundTransparency=0.25 end end)
        btn.MouseLeave:Connect(function() if CategoryRefs.active~=name then btn.TextColor3=C.purple; btn.BackgroundTransparency=0.3 end end)
    end
    local spBtn=CategoryRefs.btnsSide["Speed"]
    if spBtn then spBtn.TextColor3=C.purple; spBtn.BackgroundTransparency=0.2; local i2=spBtn:FindFirstChild("indicator"); if i2 then i2.BackgroundTransparency=0.3 end end
end)()
